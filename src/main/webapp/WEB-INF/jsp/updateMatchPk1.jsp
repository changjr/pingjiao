...
<html>
 ...
 <div class="layui-form-item">
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-form-item">
    <label class="layui-form-label">第一位歌曲名</label>
    <div class="layui-input-block">
      <input type="text" name="firstSongName" value="${ matchPk.firstSongName}" placeholder="请输入比赛名称" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
    <label class="layui-form-label">第二位歌曲名</label>
    <div class="layui-input-block">
      <input type="text" name="secondSongName" value="${ matchPk.secondSongName}" placeholder="请输入比赛名称" autocomplete="off" class="layui-input">
    </div>    
  </div>
                  <div class="layui-form-item">
