...
<section class="service-w3ls">
    <h3 class="text-center w3layouts w3 w3l w3ls agileits-w3layouts agile w3-agile" style="color: red;">投票活动进行中</h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls" >
                    <div class="thumbnail" style="padding: 0px;height:400px;">
                        <div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
                            <a href="${ctx}/pk/listpk?matchId=${match.matchId}">
                        ...
                        <a href="${ctx}/pk/listpk?matchId=${match.matchId}" name="matchName">
    ...
    <h3 class="text-center w3layouts w3 w3l w3ls agileits-w3layouts agile w3-agile" style="color: green;margin-top: 30px;">历史投票活动</h3>
    <div class="container">
        <!-- Service Panels -->
        <div class="row" >
            <div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls" >
                <div class="thumbnail" style="padding: 0px;height:460px;">
                    <div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
                        <a href="#">
                            <div style="width: 260px;height: 220px;background: pink;">
                                <img src="${ctx}/static/images/zhanfang1.png" width="260" height="220">
                            </div>
                        </a>
                    </div>
                    <a href="#"><h4 class="text-center" style="height: 125px;"> 绽放杯”5G应用征集大赛“最佳人气奖”投票平台</h4></a>
                    <div style="width: 220px;height:80px;margin: 10px 20px;text-align: center;">
                        <div style="width: 60px;height: 60px; margin-right: 10px;float: left;">
                            <div style="width: 60px;height: 30px; line-height: 30px;">
                                70
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls" >
                <div class="thumbnail" style="padding: 0px;height:460px;">
                    <div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a" >
                        <a href="#">
                            <div style="width: 260px;height: 220px;background: pink;">
                                <img src="${ctx}/static/images/haiwang.png" width="260" height="220">
                            </div>
                        </a>
                    </div>
                    <a href="#"><h4 class="text-center" style="height: 125px;">海王星辰“幸福杯”POP大赛</h4></a>
                    <div style="width: 220px;height:80px;margin: 10px 20px;text-align: center;">
                        <div style="width: 60px;height: 60px; margin-right: 10px;float: left;">
                            <div style="width: 60px;height: 30px; line-height: 30px;">
                                78
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls">
                <div class="thumbnail" style="padding: 0px;height:460px;">
                    <div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
                        <a href="#">
                            <div style="width: 260px;height: 220px;background: pink;">
                                <img src="${ctx}/static/images/fendou.png" width="260" height="220">
                            </div>
                        </a>
                    </div>
                    <a href="#"><h4 class="text-center" style="height: 125px;">奋斗的青春最美丽”第十二届“历城十大杰出青年”评选</h4></a>
                    <div style="width: 220px;height:80px;margin: 10px 20px;text-align: center;">
                        <div style="width: 60px;height: 60px; margin-right: 10px;float: left;">
                            <div style="width: 60px;height: 30px; line-height: 30px;">
                                80
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 serv-w3ls">
                <div class="thumbnail" style="padding: 0px;height:460px;">
                    <div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
                        <a href="#">
                            <div style="width: 260px;height: 220px;background: pink;">
                                <img src="${ctx}/static/images/puer.png" width="260" height="220">
                            </div>
                        </a>
                    </div>
                    <a href="#"><h4 class="text-center" style="height: 125px;">普洱市孟连县楠铃锻第一届摄影大赛</h4></a>
                    <div style="width: 220px;height:80px;margin: 10px 20px;text-align: center;">
                        <div style="width: 60px;height: 60px; margin-right: 10px;float: left;">
                            <div style="width: 60px;height: 30px; line-height: 30px;">
                                92
