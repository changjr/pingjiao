...
<table width="100%" cellpadding="5" cellspacing="0" class="layui-table">
    ...
    <c:forEach items="${matchList}" var="match" varStatus="stat">
        <tr align="center">
            ...
            <td>${match.battleFlag }</td>
            <c:if test="${match.battleFlag==null}">
            <td><a class="layui-btn layui-btn-normal delete" href="javascript:;" battleId="${match.battleId}" matchId="${match.matchId}">投票</a></td>
            </c:if>
        </tr>
    </c:forEach>
</table>
