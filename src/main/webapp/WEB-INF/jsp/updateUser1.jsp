            ...
            <form action="${ctx}/user/updatesave" method="post" class="layui-form">
                ...
                <div class="layui-form-item" style="margin-top:50px;">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="account" value="${user.account}" required lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="telephone" value="${user.telephone}" name="telephone" required
                               lay-verify="required|phone" placeholder="请输入比赛地点" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">身份</label>
                    <div class="layui-input-block">
                        <select name="scale" lay-verify="required" onChange="set_pt(this, this.form.pt);">
